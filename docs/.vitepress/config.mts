			...
			themeConfig: {
				...
				sidebar: {
					...
					'/guide/': [
						...
						{
							items: [
								{ link: '/guide/ultimate', text: 'Ultimate Types' },
								{ link: '/guide/hkt', text: 'Higher-Kinded Types' },
								{ link: '/guide/build-tools', text: 'Build Tools' },
								{ link: '/guide/devops', text: 'DevOps' },
								{ link: '/guide/qa', text: 'Quality Assurance' },
								{ link: '/guide/accessibility', text: 'Accessibility' },
								{ link: '/guide/polish', text: 'Final Polish' },
							],
							text: 'v1.10.0',
						},
						{
							items: [
								{ link: '/guide/experimental-v2', text: 'Experimental v2' },
								{ link: '/guide/unified-type-system', text: 'Unified Type System' },
								{ link: '/guide/hkt-v2', text: 'HKT Preview' },
								{ link: '/guide/effect-system', text: 'Effect System' },
								{ link: '/guide/plugin-v2', text: 'Plugin System v2' },
								{ link: '/guide/interop-v2', text: 'Interop Enhancements' },
								{ link: '/guide/devtools', text: 'Developer Tools' },
								{ link: '/guide/docgen-v2', text: 'Doc Generation v2' },
								{ link: '/guide/community-feedback', text: 'Community Feedback' },
								{ link: '/guide/rc-quality-gates', text: 'RC Quality Gates' },
							],
							text: 'v1.12.0',
						},
						{
							items: [
								{ link: '/guide/migration-toolkit', text: 'Migration Toolkit' },
								{ link: '/guide/v2-beta', text: 'v2.0.0 Beta Features' },
								{ link: '/guide/breaking-changes-final', text: 'Final Breaking Changes' },
								{ link: '/guide/dual-mode', text: 'Dual Mode Support' },
								{ link: '/guide/performance-final', text: 'Final Performance' },
								{ link: '/guide/community-ecosystem', text: 'Community & Ecosystem' },
								{ link: '/guide/final-doc', text: 'Final Documentation' },
								{ link: '/guide/stability-final', text: 'Final Stability & Polish' },
								{ link: '/guide/eol-planning', text: 'End-of-Life Planning' },
			...
			themeConfig: {
				...
				sidebar: {
					...
					'/zh/guide/': [
						...
						{
							items: [
								{ link: '/zh/guide/ultimate', text: '极致类型' },
								{ link: '/zh/guide/hkt', text: '高阶类型' },
								{ link: '/zh/guide/build-tools', text: '构建工具' },
								{ link: '/zh/guide/devops', text: 'DevOps' },
								{ link: '/zh/guide/qa', text: '质量保证' },
								{ link: '/zh/guide/accessibility', text: '无障碍访问' },
								{ link: '/zh/guide/polish', text: '最终优化' },
							],
							text: 'v1.10.0',
						},
						{
							items: [
								{ link: '/zh/guide/experimental-v2', text: '实验性 v2' },
								{ link: '/zh/guide/unified-type-system', text: '统一类型系统' },
								{ link: '/zh/guide/hkt-v2', text: '高阶类型预览' },
								{ link: '/zh/guide/effect-system', text: '效果系统' },
								{ link: '/zh/guide/plugin-v2', text: '插件系统 v2' },
								{ link: '/zh/guide/interop-v2', text: '互操作增强' },
								{ link: '/zh/guide/devtools', text: '开发者工具' },
								{ link: '/zh/guide/docgen-v2', text: '文档生成 v2' },
								{ link: '/zh/guide/community-feedback', text: '社区反馈' },
								{ link: '/zh/guide/rc-quality-gates', text: 'RC 质量门控' },
							],
							text: 'v1.12.0',
						},
						{
							items: [
								{ link: '/zh/guide/migration-toolkit', text: '迁移工具包' },
								{ link: '/zh/guide/v2-beta', text: 'v2.0.0 测试版功能' },
								{ link: '/zh/guide/breaking-changes-final', text: '最终破坏性变更' },
								{ link: '/zh/guide/dual-mode', text: '双模式支持' },
								{ link: '/zh/guide/performance-final', text: '最终性能优化' },
								{ link: '/zh/guide/community-ecosystem', text: '社区与生态' },
								{ link: '/zh/guide/final-doc', text: '最终文档' },
								{ link: '/zh/guide/stability-final', text: '最终稳定性与打磨' },
								{ link: '/zh/guide/eol-planning', text: '生命周期终止规划' },
